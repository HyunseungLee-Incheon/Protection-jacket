...
class BluetoothClassicManager {
    companion object {
        ...
        private var mInstance: BluetoothClassicManager = BluetoothClassicManager()
        fun getInstance(): BluetoothClassicManager {
            return mInstance
        }
    }
    ...
    private inner class AcceptThread : Thread() {
        ...
        override fun run() {
            ...
            while (this@BluetoothClassicManager.state != STATE_CONNECTED) {
                try {
                    // This is a blocking call and will only return on a
                    // successful connection or an exception
                    if (mmServerSocket != null) {
                        this@BluetoothClassicManager.state = STATE_CONNECTING
                        socket = mmServerSocket.accept()
                    }
                } catch (e: IOException) {
                    this@BluetoothClassicManager.state = STATE_NONE
                ...
                if (socket != null) {
                    when (this@BluetoothClassicManager.state) {
    ...
    private inner class ConnectThread(private val mmDevice: BluetoothDevice) : Thread() {
        ...
        override fun run() {
            ...
            try {
                ...
                this@BluetoothClassicManager.start()
                return
            }

            // Reset the ConnectThread because we're done
            synchronized(this@BluetoothClassicManager) {
                mConnectThread = null
            }
    ...
    private inner class ConnectTimerTask : TimerTask() {
        override fun run() {
            ...
            mHandler?.post {
                ...
                val addrs = Constants.strDeviceAddress
